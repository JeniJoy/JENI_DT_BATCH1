	...
	<div class="carousel slide carousel-fade" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img class="img-responsive" src="resources/images/a9090.jpg" />
			</div>
			<div class="item">
				<img class="img-responsive" src="resources/images/b9090.jpg" />
			</div>
			<div class="item">
				<img class="img-responsive" src="resources/images/c9090.jpg" />
			</div>
			<div class="item">
				<img class="img-responsive" src="resources/images/d9090.jpg" />
			</div>
			<div class="item">
				<img class="img-responsive" src="resources/images/e9090.jpg" />
			</div>
			<div class="item">
				<img class="img-responsive" src="resources/images/f9090.jpg" />
			</div>
