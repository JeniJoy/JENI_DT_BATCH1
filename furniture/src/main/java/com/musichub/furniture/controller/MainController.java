...
public class MainController {
	...
	public ModelAndView homeadmin(ModelMap model, Principal principal) {
		...
		model.addAttribute("message", "Dear Admin Welcome To Furniture.com");
	...
	public ModelAndView homeuser(ModelMap model, Principal principal) {
		String name = principal.getName();
		model.addAttribute("author", name);
		model.addAttribute("message", "Dear User Welcome To Furniture.com");
	...
	ModelAndView storeproduct(HttpServletRequest request, @RequestParam("file") MultipartFile file,
		...
		if (!file.isEmpty()) {
			try {
				...
				BufferedOutputStream buffStream = new BufferedOutputStream(new FileOutputStream(
						new File("D:/DIGI_NEXT_WORKSPACE_V1/furniture/src/main/webapp/resources/images/" + fileName)));
		...
		File oldName = new File("D:/DIGI_NEXT_WORKSPACE_V1/furniture/src/main/webapp/resources/images/" + fileName);
		File newName = new File("D:/DIGI_NEXT_WORKSPACE_V1/furniture/src/main/webapp/resources/images/" + p.getPid()
